...
function Recepit() {
  ...
  return (
    ...
    <div className='report'>
      ...
      <Table  className='report-table' columns={columns} style={{ boxShadow:' 0 0 10px rgba(0, 0, 0, 0.2)', height:'70vh', background:'white', marginTop:'25px'  }} dataSource={dataSource} pagination={pagination}
         scroll={{
          y: 'calc(70vh - 190px)', 
          x: 'max-content', 
        }}  
    ...
    <div className='recepit-grades'>
      <button className='btn-grade-recepit'>
        {gradeList.map((grade) => (
          <div
            key={grade}

    ...
    <FontAwesomeIcon icon={faUserPlus} />Add Student
      ...
      <div className='card-table'>
        <div className='table-part'>
          <Table className='custom-table' style={{width:'70vw', boxShadow:' 0 0 10px rgba(0, 0, 0, 0.2)', height:'70vh', background:'white', marginTop:'10px', marginLeft:'100px'}} columns={columns} dataSource={dataSource} pagination={pagination}
         scroll={{
          y: 'calc(70vh - 190px)', 
          x: 'max-content', 
        }} />
